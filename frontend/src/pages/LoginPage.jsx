...
import { ShieldCheckIcon } from '@heroicons/react/24/outline'; // Make sure to install @heroicons/react
        ...
        <div className="flex w-full max-w-7xl mx-auto overflow-hidden">
          ...
          <div className="w-1/2 hidden md:flex flex-col justify-center pr-16">
            ...
            <p className="text-gray-400 text-lg mb-10">
              Sign in to access your preventive plans, track your lifestyle, and connect with your care team.
            </p>
